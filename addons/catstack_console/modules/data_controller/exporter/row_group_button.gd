...
@export var unpressed_icon:Texture2D = preload("res://addons/catstack_console/res/icons2/chevron_right.svg")
@export var pressed_icon:Texture2D = preload("res://addons/catstack_console/res/icons2/expand_more.svg")
