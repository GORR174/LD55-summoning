...
const play_icon:Texture2D = preload("res://addons/catstack_console/res/icons2/play-1001-svgrepo-com.svg")
const pause_icon:Texture2D = preload("res://addons/catstack_console/res/icons2/pause-1010-svgrepo-com.svg")
const expand_icon:Texture2D = preload("res://addons/catstack_console/res/icons2/chevron_right.svg")
const collapse_icon:Texture2D = preload("res://addons/catstack_console/res/icons2/expand_more.svg")
