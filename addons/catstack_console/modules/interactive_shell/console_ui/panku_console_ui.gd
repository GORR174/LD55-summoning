...
const side_button_packed := preload("res://addons/catstack_console/modules/interactive_shell/console_ui/side_button.tscn")
const side_menu_config_file_path := "res://addons/catstack_console/modules/interactive_shell/side_menu_config.json"
