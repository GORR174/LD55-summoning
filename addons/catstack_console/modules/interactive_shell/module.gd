...
func get_intro() -> String:
	...
	intro.append("[font_size=56][color=#ffffff44][b][i]> Catstack Console[/i][/b][/color][/font_size]")
	intro.append("[font_size=18][color=#ffffff44]Based on PankuConsole v1.7.7[/color][/font_size]")
	intro.append("[font_size=18][color=#ffffff44]Version: %s" % [PankuUtils.get_plugin_version()])
	return "\n".join(intro)
